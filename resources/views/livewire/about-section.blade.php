          ...
          <blockquote class="relative bg-white rounded-lg shadow-lg">
            <div class="rounded-t-lg px-6 py-8 sm:px-10 sm:pt-10 sm:pb-8">
              ...
              <div class="relative text-lg text-gray-700 font-medium mt-8">
                ...
                <p class="relative">When it comes to efficiency, dedication, and quality of work, Ragazza Contracting is where I turn to.  There is no one that can come close.</p>
              </div>
            </div>
            <cite class="relative flex items-center sm:items-start bg-red-600 rounded-b-lg not-italic py-5 px-6 sm:py-5 sm:pl-12 sm:pr-10 sm:mt-10">
              <div class="relative rounded-full border-2 border-white sm:absolute sm:top-0 sm:transform sm:-translate-y-1/2">
                <img class="w-12 h-12 sm:w-20 sm:h-20 rounded-full bg-red-300" src="{{ asset('/img/mark.png') }}" alt="Mark Papadimitriou">
              </div>
              <span class="relative ml-4 text-red-300 font-semibold leading-6 sm:ml-24 sm:pl-1">
                <p class="text-white font-semibold sm:inline">Mark Papadimitriou</p>
                <p class="sm:inline">CEO at Themis Chimney, Inc.</p>
              </span>
            </cite>
          </blockquote>
        </div>
