        ...
        <div x-data="{ open: false }">
            <nav class="relative max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6" aria-label="Global">
                ...
                <div class="flex items-center flex-1">
                    ...
                    {{-- Block with the company logo and the open/close button --}}
                    ...
                    {{-- Block with the nav tabs on top. --}}
            ...
            {{-- Div that shows mobile menu when you click open icon. --}}
            <div
                x-show="open"
                ...
                <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                    ...
                    {{-- Top Portion: of the mobile Menu --}}
                    <div class="px-5 pt-4 flex items-center justify-between">
                        ...
                        {{-- Div that holds Close (x) icon button. --}}
                        <div class="-mr-2">
                    ...
                    {{-- Center Portion: List of links for mobile menu --}}
                    ...
                    {{-- Lower Portion: If there is a route for 'login', then display Log In/Register --}}
                    @if (Route::has('login'))
                        <div>

                            {{-- If authenticated, then show dashboard. --}}
                            @auth
                                <a href="{{ url('/dashboard') }}"
                            ...
                            @else
                                ...
                                {{-- If There is a register route, then dispaly register.  Some app will not require a register backend. --}}
                                @if (Route::has('register'))
